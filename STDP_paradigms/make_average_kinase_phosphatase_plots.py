...
colors = {"positive pairing": "black",
          "negative pairing": "gray",
          "negative pairing + DA": "dodgerblue",
          "positive pairing + D1R antagonists": "purple",
          "negative pairing + DA + PKA inhibitors": "r",
          "negative pairing + ISO": "forestgreen",
          "positive pairing + D1R antagonists": "yellow",
}

labels = {
    "positive pairing": "positive pairing",
    "negative pairing": "negative pairing",
    "negative pairing + DA": "negative pairing + DA",
    "positive pairing + D1R antagonists": "positive pairing + D1R antagonists",
...
filename_dict = {    
    "positive pairing": "model_STDP_+10_ms_trial",
    "negative pairing": "model_STDP_-20_ms_trial",
    "negative pairing + DA": "model_STDP_-20_ms_DA_pre_trial",
    "positive pairing + D1R antagonists": "model_STDP_+10_ms_SCH_23390_trial",
